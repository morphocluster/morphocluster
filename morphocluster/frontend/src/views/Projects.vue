                    ...
                    <div slot="progress" slot-scope="data">
                        ...
                        >
                            <b-progress-bar
                                ...
                                v-b-tooltip.hover
                                :title="
                                    `${data.item.progress.leaves_n_filled_nodes} / ${data.item.progress.leaves_n_nodes} filled up`
                                "
                            />
                            <b-progress-bar
                                variant="warning"
                                ...
                                v-b-tooltip.hover
                                :title="
                                    `${data.item.progress.leaves_n_approved_nodes} / ${data.item.progress.leaves_n_nodes} approved`
                                "
                            />
