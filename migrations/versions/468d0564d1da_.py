...
def upgrade():
    ...
    op.create_foreign_key(None, 'nodes', 'nodes', ['parent_id'], ['node_id'], ondelete='SET NULL')
    op.create_foreign_key(None, 'nodes', 'projects', ['project_id'], ['project_id'], ondelete='CASCADE')
