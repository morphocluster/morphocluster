<!-- This view template shows how to configure views with multiple vertically stacked panes. -->
<template>
    <div id="dummy_multi" class="d-flex flex-column fill-height">
        <div class="flex-1 overflow-y-auto">
            ...
            diam voluptua. At vero Twoeos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea
